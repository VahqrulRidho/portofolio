                ...
                <div class="card-body">
                    <div class="col-lg-12">
                        <div class="pull-left mb-3">
                            <h4 class="font-weight-bold text-primary">Tambah Portofolio</h4>
                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="judul" class="form-control"
                                            placeholder="Judul Portofolio" value="{{ old('judul') }}" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="tgl_project" class="form-control"
                                            placeholder="Tanggal Project" value="{{ old('tgl_project') }}" required>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <di<label style="font-weight: bold;">Foto</label>
                                            <input type="file" class="form-control" name="foto[]"
                                                placeholder="Masukkan Foto" multiple required>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label style="font-weight: bold;">Deskripsi</label>
                                        <textarea name="deskripsi" class="form-control" placeholder="Input Deskripsi" rows="5"
