                ...
                <div class="card-body">
                    <div class="col-lg-12">
                        <div class="pull-left mb-3">
                            <h4 class="font-weight-bold text-primary">Tambah Data Service</h4>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="deskripsi" class="form-control" rows="5" placeholder="Deskripsi" required>{{ old('deskripsi') }}</textarea>
                                    </div>
                                </div>
